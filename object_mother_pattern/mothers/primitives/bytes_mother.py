...
class BytesMother(BaseMother[bytes]):
    ...
    def create(cls, *, value: bytes | None = None, min_length: int = 1, max_length: int = 128) -> bytes:
        ...
        Args:
            ...
            min_length (int, optional): Minimum length of the generated bytes. Must be >= 1. Defaults to 1.
    ...
    def of_length(cls, *, length: int) -> bytes:
        ...
        Args:
            length (int): The length of the bytes value to generate. Must be an integer >= 1.
